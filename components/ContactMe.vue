<template>
  <section
    class="min-h-screen bg-gradient-to-tr from-blue-600 via-blue-800 to-blue-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900"
  >
      ...
      <div class="flex-1 lg:flex lg:items-center">
        <div class="text-white lg:w-1/2 lg:mx-6">
          ...
          <div class="mt-6 space-y-8 md:mt-8">
            <p class="flex items-start -mx-2">
              ...
              <span class="mx-2 text-white">
                San pendro Ext., Davao del sur, Davao City
              </span>
            </p>
          ...
          <div class="mt-6 md:mt-8">
            <h3 class="text-gray-300">Social</h3>
        ...
        <div class="mt-8 lg:w-1/2 lg:mx-6">
          ...
          >
            ...
            <form class="mt-4" ref="form" @submit.prevent="sendEmail">
              <div class="flex-1">
                <label
